...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      {/* Hero Content */}
      <div className={`text-center z-10 px-4 md:px-8 transition-all duration-2000 ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
      }`}>
        <h1 className="font-heading font-light mb-8 md:mb-12 leading-[0.8] tracking-tight">
          <span className="block text-3xl md:text-5xl lg:text-7xl text-cosmic-gold mb-6 md:mb-8 shimmer-reveal-animation">
        ...
        <div className={`space-y-4 md:space-y-6 transition-all duration-1500 delay-1000 ${
        ...
        <div className={`mt-12 md:mt-20 transition-all duration-1500 delay-1400 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
          <button 
            onClick={scrollToNextSection}
            className="elite-cta-button-hero-mobile text-lg md:text-xl group relative"
          >
            <span className="relative z-10 inline-flex items-center">
              Explore Solutions
              <svg 
                className="ml-3 md:ml-4 w-5 h-5 md:w-6 md:h-6 transition-transform duration-500 group-hover:translate-x-2" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
